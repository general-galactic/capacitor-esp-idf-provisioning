...
public class EspProvisioningPlugin extends Plugin {
    ...
    private void blePermissionCallback(PluginCall call) {
        Log.d("phun", String.format("Requested ble permissions: hasBLEHardware=%b; blePermissionGranted=%b;", this.implementation.hasBLEHardware(), this.blePermissionGranted()));
    }

    @PermissionCallback()
    private void locationPermissionCallback(PluginCall call) {
        Log.d("phun", String.format("Requested location permissions: locationPermissionGranted=%b;", this.locationPermissionGranted()));
    }
